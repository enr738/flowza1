...
import { CornerUpLeft, MoreVertical, Paperclip, Send, CheckCircle2 } from 'lucide-react';
...
export default function ChatPage({ params }: { params: { orderId: string } }) {
  ...
  const [messages, setMessages] = useState([
    { id: 1, text: 'Hi Sarah, I just placed the order!', sender: 'me', time: '10:00 AM' },
    { id: 2, text: "Hello! Thank you for the order. I've received the requirements.", sender: 'them', time: '10:02 AM' },
    { id: 3, text: 'I will start working on the initial concepts today. Should have something for you to review by Wednesday.', sender: 'them', time: '10:03 AM' },
    { id: 4, text: 'Perfect, looking forward to it. Let me know if you need anything else.', sender: 'me', time: '10:15 AM' },
  ]);
