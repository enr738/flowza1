          ...
          <Card key={i} className="p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
               <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-white mb-1">Corporate Identity Design</h3>
                    <p className="text-sm text-text-secondary mb-3">Client: Acme Corp • Ordered: Oct 24, 2023</p>
                    <div className="flex items-center gap-3">
                      <span className="px-3 py-1 rounded-full text-xs font-semibold bg-warning/10 text-warning border border-warning/20">
                        In Progress
                      </span>
                      <span className="text-sm text-text-secondary">Due in 3 days</span>
                    </div>
                  </div>
               </div>
               ...
               <div className="flex md:flex-col items-center md:items-end justify-between md:justify-center gap-4 border-t md:border-t-0 md:border-l border-border pt-4 md:pt-0 md:pl-6 w-full md:w-auto">
                 <div className="text-right">
                   <p className="text-xs text-text-secondary mb-1 uppercase tracking-wider">Amount</p>
